...
from sit_control.parameters import BiologicalParameters, ControlConfig, NumericalConfig
...
def test_perturb_K_does_not_affect_R0(params: BiologicalParameters) -> None:
    ...
    assert p_high.R0 == pytest.approx(params.R0, rel=1e-9)
        ...
        "perturbations": {
            ...
            "K": {
                ...
                "runs": {
                    ...
                    "+20%": {"J": 1.71e5, "t_epsilon_days": 105.0, "delta_J_pct": +17.1},
                },
            },
        },
    }
