...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "verify":
        ...
        sys.argv = [
            ...
            str(args.output),
            "--tau-values",
            *[str(t) for t in args.tau_values],
            "--tau-optimal",
            str(args.tau_optimal),
            "--c-weight",
            str(args.c_weight),
        ]
        _main()
        ...
        argv = [
            ...
            str(args.seed),
            "--randomize-low",
            str(args.randomize_low),
            "--randomize-high",
            str(args.randomize_high),
        ]
